...
import { DefaultColumnFilter } from "../Tax/filters";
import JobListGlobalFilter from "../../components/Common/GlobalSearchFilter";
import { useState } from "react";
import AddReducetex from "./AddReducetex";
  ...
  return (
    <Fragment>
      ...
      >
        ...
        <OffcanvasBody>
          <AddReducetex onTrigger={trigger} />
        </OffcanvasBody>
      </Offcanvas>
    </Fragment>
  );
...
TableContainerReduce.propTypes = {
  preGlobalFilteredRows: PropTypes.any,
};

export default TableContainerReduce;
