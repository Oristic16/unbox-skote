...
const NonApproveLeave = () => {
  ...
  return (
    <React.Fragment>
          ...
          <div className="my-4" style={{ border: "2px solid #3a40cd" }}></div>
          <TabContent activeTab={activeTab1}>
            <TabPane tabId="5">
              <h5>รายการลาพักผ่อนที่ยังไม่ได้รับอนุมัติ</h5>
              <Form className="mt-3">
                <Row className="mt-4" style={{display:"flex",justifyContent:"end"}}>
                  <Label className="text-end" xxl={2} xl={2} sm={2} xs={4}>
                    ช่วงวันที่
                  </Label>
                  <Col xxl={4} xl={4} sm={4} xs={8}>
                    <Flatpickr
                ...
                <Row className="mt-4 d-flex justify-content-end">
                  <Col xxl={4} xl={4} sm={4} xs={5} className="d-flex justify-content-end">
                    <Button
                      color="info"
                ...
                <Row className="mt-4">
                  <Col className="d-flex justify-content-end">
                    ...
                    >
                      ค้นหา
                      {/* <span className="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-success font-size-16">
                        {data.length}{" "}
                      </span> */}
                    </Button>
                  </Col>
