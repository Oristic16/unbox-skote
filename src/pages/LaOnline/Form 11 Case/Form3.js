...
const Form3 = ({ idForm, closeCanvas }) => {
  ...
  const formValidate = useFormik({
    ...
    validationSchema: Yup.object().shape({
      abroad_for: Yup.string().required("กรุณาระบุข้อมูล"),
      abroad_country: Yup.string().required("กรุณาระบุข้อมูล"),
    }),
    onSubmit: (values) => {
      console.log(values);
    },
  ...
  return (
    ...
    >
      ...
      <FormGroup row>
        ...
        <Col xl={4}>
          <Input
            disabled
            type="text"
            onChange={(e) => handleInputChange(e, 'leaveReq')}
            value={data.leaveReq}
          />
        </Col>
      </FormGroup>
      <FormGroup row>
        <Label className="text-end" xl={2}>
        <span className="me-1 text-danger">*</span>เพื่อไป
        </Label>
        <Col xl={4}>
          <Input
            name="abroad_for"
            ...
            onChange={(e) => {
              ...
              handleInputChange(e, 'abroadFor')
            }}
            value={formValidate.values.abroad_for}
            invalid={formValidate.touched.abroad_for && formValidate.errors.abroad_for ? true : false}
            valid={formValidate.touched.abroad_for && !formValidate.errors.abroad_for ? true : false}
          />
          {formValidate.touched.abroad_for && formValidate.errors.abroad_for ? (
            <FormFeedback type="invalid">{formValidate.errors.abroad_for}</FormFeedback>
          ) : <FormFeedback valid>สามารถใช้งานได้</FormFeedback>}
        </Col>
      </FormGroup>
      <FormGroup row>
        <Label className="text-end" xl={2}>
        <span className="me-1 text-danger">*</span>ณ ประเทศ 
        </Label>
        <Col xl={4}>
          <Input
          name="abroad_country"
          ...
          onChange={(e) => {
            formValidate.handleChange(e)
            handleInputChange(e, 'abroad_country')
          }} 
          value={formValidate.values.abroad_country} 
          type="text"
          invalid={formValidate.touched.abroad_country && formValidate.errors.abroad_country ? true : false}
          valid={formValidate.touched.abroad_country && !formValidate.errors.abroad_country ? true : false}
          />
          {formValidate.touched.abroad_country && formValidate.errors.abroad_country ? 
        (<FormFeedback type="invalid">{formValidate.errors.abroad_country}</FormFeedback>) 
        : <FormFeedback valid>สามารถใช้งานได้</FormFeedback>}
        </Col>
      ...
      <FormGroup row style={{display:"flex",alignItems:"center"}}>
        <Label className="text-end" xl={3}>
            ได้ลากิจ/ลาพักผ่อนวันที่
        </Label>
        <Col xl={4}>
          <Input
            type="select"
            value={data.abroadRef}
            onChange={(e) => handleInputChange(e, 'abroadRef')}
          >
            <option></option>
            <option>1</option>
            <option>2</option>
      ...
      <FormGroup row style={{display:"flex",alignItems:"center"}}>
        ...
        <Col xxl={5}>
          ...
          type="file" 
          multiple 
          onChange={(e) => setData((prevData) => ({...prevData, file: e.target.value}))} />
        </Col>
        <Col>
        <Button onClick={(e) => {
