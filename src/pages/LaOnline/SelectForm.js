...
const SelectForm = ({ userInfo, idForm, closeCanvas, configForm, getLeaveDataTable }) => {
  ...
  const checkIdForm = () => {
    ...
    switch (idForm) {
      case "1":
        return (<Form1 userInfo={userInfo} idForm={idForm} configForm={configForm} closeCanvas={closeCanvas} getLeaveDataTable={getLeaveDataTable} />);
      case "2":
