...
class RateServicce extends Component {
  constructor(props) {
    super(props);
              ...
              <Col lg={12}>
                <Row className="mb-4">
                  ...
                  <Col lg={9} xl={9}>
                    ...
                    <Row>
                        <Col>
                        <InputGroup style={{ width: "40%" }} className="mt-2">
                          ...
                          return (
                            ...
                            <tr>
                              ...
                              <td className="align-middle">
                                <div className="d-flex align-items-center">
                                  <i className="fa-solid fa-user fa-xl pe-1"></i>
                                  <span className="fs-6"> กฤษณา แก้วด้วง</span>
                                </div>
                              </td>
                              <td className="align-middle"></td>
                              <td className="align-middle">
                              ...
                              <td className="align-middle">
                                <div className="d-flex align-items-center">
                                  ...
                                  <Badge
                                    ...
                                    className="p-2 bg-opacity-10"
                                  >
                                    <span className="text-danger fs-6">ดี</span>
                                  </Badge>
                                </div>
                              </td>
                              <td className="align-middle">
...
export default withTranslation()(RateServicce);
