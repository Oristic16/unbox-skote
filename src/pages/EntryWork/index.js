...
const EntryWork = () => {
  ...
  const handleCheckEntry = () => {
    ...
    .then((res) => {
      ...
      if(lastEleDate === new Date().toLocaleDateString() && lastEleTimeOut === null){
  ...
  const handleEntryWork = async (time) => {
    await axios.post(baseURL + 'addentrywork', {
          ...
          <Col xl={3}>
            <Card style={{ minHeight: "460px" }}>
              ...
              <CardBody style={{position:'relative'}}>
                ...
                {isEntry ?
                  <Row className="me-2" style={{position:"absolute", bottom: 0, right: 0}}>
                    <Col>
                      <p className="text-danger">คุณสามารถออกงานได้ในเวลา</p> 
                    </Col>
                  </Row>
                : null}
              </CardBody>
              ...
              <Col>
                <Card>
                  <CardBody className="pb-0">
                    <Row>
                      <Col xl={6} xxl={3}>
                        <Card style={{display:"flex",alignItems:"center",justifyContent:"center"}} className="bg-success bg-gradient p-5">
                          <Row>
                            <Col>
                              <h4>เต็มเวลา</h4>
                            </Col>
                      ...
                      <Col xl={6} xxl={3}>
                        <Card style={{display:"flex",alignItems:"center",justifyContent:"center"}} className="bg-danger bg-gradient p-5">
                          <Row>
                            <Col>
                              <h4>ขาด</h4>
                            </Col>
